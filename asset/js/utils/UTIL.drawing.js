var drawing={}
drawing.canvasList=[],drawing.drawBGShapes=function(){$(".drawing-shape").each(function(){console.log("draw: ",$(this))
var a,t,i=$(this),e=300,n=$(window),r=n.width()>n.height()?n.width():n.height(),s=i.attr("drawing-shape-type")
